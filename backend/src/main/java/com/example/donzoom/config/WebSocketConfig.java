...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
  ...
  public void registerStompEndpoints(StompEndpointRegistry registry) {
    registry.addEndpoint("/websocket")
        .setAllowedOrigins("https://j11a108.p.ssafy.io", "https://localhost:5500", "https://127.0.0.1:5500", "http://127.0.0.1:5500", "http://localhost:5500")  // 여기에 허용할 도메인 추가
  ...
  public void handleWebSocketDisconnectListener(SessionDisconnectEvent event) {
    ...
    for (String stockId : stockSessionCounts.keySet()) {
      if (stockSessionCounts.containsKey(stockId)) {
        ...
        log.info("{}에서 웹소켓 연결이 해제되었습니다. stockId: {}, 현재 연결 수: {}", sessionId, stockId, currentCount);
      }
    }
  }
}
