...
export default function InvestmentHomeScreen() {
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
          ...
          <View style={styles.assetHeaderContainer}>
            <View style={styles.assetInnerHeaderContainer}>
              ...
              <View style={styles.notification}>
                <Text style={styles.notificationText}> <Icon name="bell-fill" size={15} color="black" /> 투자 알림</Text>
              </View>
            </View>
          </View>
        ...
        <TouchableOpacity>
          <View style={styles.safeAssetHeaderContainer}>
            <Text style={styles.safeAssetHeaderText}>안전 자산  <Icon2 name="right" size={15} color="black" /></Text>
          </View>
        </TouchableOpacity>
        ...
        <View style={styles.statusContainer}>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.cell, styles.borderTop,styles.borderRight,styles.borderBottom]}>
        ...
        <View style={styles.statusContainer}>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.cell,styles.borderTop,styles.borderBottom,styles.borderRight]}>
              <Text style={styles.text}>10,000</Text>
            </View>
            <View style={[styles.cell, styles.borderTop, styles.borderBottom]}>
        ...
        <TouchableOpacity>
          <View style={styles.safeAssetHeaderContainer}>
            <Text style={styles.safeAssetHeaderText}>위험 자산 <Icon2 name="right" size={15} color="black" /></Text>
          </View>
        </TouchableOpacity>
        ...
        <View style={styles.statusContainer}>
          ...
          <View style={styles.row}>
            <View style={[styles.cell,styles.borderTop,styles.borderRight, styles.yellow]}>
            ...
            <View key={index} style={styles.row}>
              <View
                style={[
                  ...
                  styles.borderTop,
                  styles.borderRight,
                  index === stockData.length - 1 ? styles.bottomLeftRadiusCell : null, // 마지막 행의 왼쪽 셀
                ]}
              >
              ...
              <View
                style={[
                  styles.cell,
                  styles.borderTop,
                  index === stockData.length - 1 ? styles.bottomRightRadiusCell : null,
                ]}
              >
                <Text style={[styles.unSafeText,styles.redText]}>{stock.change}</Text>
              </View>
            </View>
          ))}
        </View>
